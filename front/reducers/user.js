...
const initialState = {
  loadMyInfoLoading: false, // 내 정보 로드
  loadMyInfoDone: false,
  loadMyInfoError: null,
  loadFollowingsLoading: false, // 팔로잉 로드
  loadFollowingsDone: false,
  loadFollowingsError: null,
  loadFollowersLoading: false, // 팔로워 로드
  loadFollowersDone: false,
  loadFollowersError: null,
  loadUserLoading: false, // 유저 정보 로드
  loadUserDone: false,
  loadUserError: null,
...
export const LOAD_MY_INFO_REQUEST = "LOAD_MY_INFO_REQUSET";
...
export const UNFOLLOW_REQUEST = "UNNFOLLOW_REQUEST";
export const UNFOLLOW_SUCCESS = "UNNFOLLOW_SUCCESS";
export const UNFOLLOW_FAILURE = "UNNFOLLOW_FAILURE";
